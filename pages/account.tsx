...
export default function Account() {
  ...
  const redirectToCustomerPortal = async () => {
    ...
    window.location.href = customerPortalSessionResponse.stripe.createBillingPortalSession.url;
  };
  ...
  const productSubscription = user?.profile?.stripeCustomer.subscriptions?.data[0]?.items.data[0];
    ...
    <section className="bg-black mb-32">
      ...
      <div className="p-4">
          ...
          footer={
            <div className="flex items-start justify-between flex-col sm:flex-row sm:items-center">
              ...
              <Button
                ...
                disabled={createCustomerPortalSessionIsPending || !productSubscription}
        ...
        <Card
          title="Invoices"
          description=""
          footer={<p>Invoices are generated automatically and sent to your email address.</p>}
        >
            ...
            return (
              <div key={invoice.id}>
                <a href={invoice.hostedInvoiceUrl}>
                  Invoice {format(fromUnixTime(invoice.created), 'yyyy-MM-dd HH:mm')}
                </a>
              </div>
            );
          })}
        ...
        >
          <div className="text-xl mt-8 mb-4 font-semibold">{userData?.displayName}</div>
        </Card>
        <Card
          title="Your Email"
